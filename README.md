...
[<p align="center"><img src="images/CanGateway.png" height="500"/></p>](./images/CanGateway.png)
...
2. Find the demo by searching: [dm-smart-can-gtwy-frdm-a-s32k312-m276](https://mcuxpresso.nxp.com/appcodehub?search=dm-smart-can-gtwy-frdm-a-s32k312-m276)
...
[<p align="center"><img src="images/UpdateCodeAndBuildProject.png" width="400"/></p>](./images/update_and_build.png)
...
- Check the location of User Buttons, LEDs, 12 Vin DC power, micro-USB connector, Motor Phases, Hall connector JP1: [<p align="center"><img src="images/S32M27XEVB-TOP.jpg" width="600"/></p>](./images/S32M27XEVB-TOP.jpg)
...
- Click on **"GO"** button to establish communication with the target board: [<p align="center"><img src="images/FreeMASTER_Connect.png" width="600"/></p>](./images/FreeMASTER_Connect.png)
- Observe the CAN speed commands from the FRDM-A-S32K312 in real-time on the FreeMASTER: [<p align="center"><img src="images/FreeMASTER_CanSpeed.png" width="600"/></p>](./images/FreeMASTER_CanSpeed.png)
...
└─ YES → Is "Fault" displayed?
    ...
    │   ├─ Ia, Ib or Ic → Verify Motor Phase connections are correct
...
- After loading the project, there is a message "NXP GCC 10.2 compiler not found":
  - Right-click on the project and select **Quick Fix** to install the required compiler: [<p align="center"><img src="images/S32DS_Qfix.png" width="600"/></p>](./images/S32DS_Qfix.png)
  - Alternatively, navigate to **S32DS Extensions and Updates > NXP GCC 10.2 > Install** and add the NXP GCC 10.2 compiler: [<p align="center"><img src="images/S32DS_GCC.png" width="600"/></p>](./images/S32DS_GCC.png)
- After loading the project, there is a message "Path to collateral manifest does not exist ${S32K3xx_AMMCLIB}".
  - Install AMMCLIB<a name="AMMCLib"></a> from **S32DS Extensions and Updates > AMMCLIB for S32K3xx/S32M27x > Install** [<p align="center"><img src="images/S32DS_AMMCLIB.png" width="600"/></p>](./images/S32DS_AMMCLIB.png)
...
>**Note**: For more general technical questions regarding NXP Microcontrollers and the differences in expected functionality, enter your questions on the [NXP Community Forum](https://community.nxp.com/)
